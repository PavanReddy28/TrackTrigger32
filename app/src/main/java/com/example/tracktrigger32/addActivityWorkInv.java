...
public class addActivityWorkInv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_activity_work_inv);
        ...
        addBtnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addTvName.getText().toString().trim().isEmpty()){
                    Toast.makeText(addActivityWorkInv.this, "Please enter a Product name", Toast.LENGTH_SHORT).show();
                }else if (addTvQuantity.getText().toString().length()<1){
                    Toast.makeText(addActivityWorkInv.this, "Please enter a valid Product quantity", Toast.LENGTH_SHORT).show();
                }else if (addTvDescription.getText().toString().isEmpty()){
                    Toast.makeText(addActivityWorkInv.this, "Please enter a valid Product Description", Toast.LENGTH_SHORT).show();
                }else if (addTvCategory.getText().toString().isEmpty()){
                    Toast.makeText(addActivityWorkInv.this, "Please enter a valid Product Category", Toast.LENGTH_SHORT).show();
                }else if (addTvId.getText().toString().isEmpty()){
                    Toast.makeText(addActivityWorkInv.this, "Please enter a valid Product Id", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    addActivityWorkInv.this.finish();
                }
            }
        });
    }
